...
async def test_basic_qa():
    ...
    with QAService() as qa_service:
        try:
            questions = [
                "2023年，我国国内生产总值（GDP）及其三大产业的增长情况如何？第三产业增加值占GDP的比重是多少？",
                "2023年，我国规模以上工业中装备制造业和高技术制造业的增加值增长表现如何？新能源汽车和太阳能电池的产量增长情况如何？",
                "2023年，我国粮食产量及主要粮食作物的种植面积变化如何？其中玉米和大豆的产量增长情况如何？",
                # "2021年全国的乡镇级区划数有多少个？",
            ]
            kb_id = 2
